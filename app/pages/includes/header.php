    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <!-- New Blog link, visible only for logged-in users -->
                <?php if (logged_in()): ?>
                    <li><a href="<?=ROOT?>/admin/posts/add" class="nav-link px-2 <?=$url[0] == 'new-blog' ? 'link-primary':'link-dark'?>">New Blog</a></li>
                <?php endif; ?>
            </ul>
            ...
            <?php if (logged_in()): ?>
                <div class="dropdown text-end">
                    ...
                    <ul class="dropdown-menu text-small">
                        ...
                        <!-- My Blog option visible only for regular users -->
                        <?php if (user('role') != 'admin'): ?>
                            <li><a class="dropdown-item" href="<?=ROOT?>/admin/posts">My Blog</a></li>
                        <?php endif; ?>
            ...
            <?php else: ?>
                <div class="ms-auto">
                    <a href="<?=ROOT?>/login" class="btn btn-outline-primary me-2">Login</a>
                    <a href="<?=ROOT?>/signup" class="btn btn-primary">Signup</a>
                </div>
            <?php endif; ?>
...
<!-- Include slider only if on the home page -->
<?php
    if($url[0] == 'home')
