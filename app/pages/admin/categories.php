...
// }
// if (!isAdmin()) {
//     echo '<script>alert("You are not authorized to access this page."); window.location.href = "http://localhost/blog/public/";</script>';
//     exit;
// }
...
<?php else: ?>
    ...
    <div class="col-md-12 mb-4">
        ...
        <a href="<?= $PAGE['next_link'] ?>" class="float-end">
